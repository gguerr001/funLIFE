...
# Define UI ----
ui <- navbarPage("funLIFE", theme = shinytheme("flatly"),
                 tabPanel('INTRODUCTION',
                          sidebarLayout(position = 'left',
                                        ...
                                        mainPanel(width = 7,
                                                  h1(tags$b('Welcome to funLIFE!')),
                                                  p(introduction ),
                                                  imageOutput('image1',  height = '400px', width= '850px'),
                                                  
                                                  h1(tags$b('funLIFE App')),
                                                  ...
                                                  p(style="text-align: justify","funLIFE was created by the CarrionLab of the Institute of Biology Leiden's  (IBL) plant-microbiome interaction department."),
                                                  headerPanel(""),
                                                  headerPanel(""),
                                                  fluidRow(
                                                    column(12,
                            ...
                            tabPanel('Gene clusters',
                                     ...
                                     sidebarLayout(position = 'left',
                                                   sidebarPanel(width = 3,'Input parameters',
                                                                selectInput('PCA_database', label = "Database:", choices = list('MCL', 'KEGG', 'COG', 'PFAM', 'DBCAN')),
                 ...
                 tabPanel('CLUSTERING',
                          tabsetPanel(
                            tabPanel('Clustering',
                                     ...
                                     sidebarLayout(position = 'left',
                                                   sidebarPanel(width = 3,'Input parameters',
                                                                selectInput('clusterclass', label = 'Upset plot data:', choices = list('MCL', 'KEGG', 'COG', 'PFAM', 'DBCAN', 'GCF')),
                 ...
                 tabPanel("PAN-CORE ANALYSIS",
                          tabsetPanel(
                            ...
                            tabPanel('Core-Genome',  
                                     ...
                                     sidebarLayout(position = 'left',
                                                   sidebarPanel(width = 3,'Input parameters',
                                                                selectInput('upsetclass', label = 'Upset plot data:', choices = list('MCL', 'KEGG', 'COG', 'PFAM', 'DBCAN', 'GCF')),
                 ...
                 tabPanel("STATISTICS",
                          ...
                          sidebarLayout(position = 'left',
                                        sidebarPanel(width = 3,
                                                     selectInput('data_for_stats', label = "Select data to make statistics:", choices = list('MCL', 'KEGG', 'COG', 'PFAM', 'DBCAN', 'GCF')),
                 ...
                 tabPanel("DOWNLOAD FASTA",
                          ...
                          sidebarLayout(position = 'left',
                                        sidebarPanel(width = 3,
                                                     ...
                                                     selectInput('msacolumn', label = 'Select database', choices = list('MCL', 'KEGG', 'COG', 'PFAM', 'DBCAN')),
...
server <- function(input, output){
  ...
  results <- reactive({
    ...
    write.table(result, 'results.txt', row.names = F) ###activate
    return(result)
  })
  ...
  output$inc<-renderUI({
    ...
    names$Microlife_name = str_remove( names$MicroLife_name, '_O.fna')
