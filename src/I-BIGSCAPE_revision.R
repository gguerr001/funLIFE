...
# sep = "\t"
write.table(network_df__distance_filtered, file = args[4], sep = "\t", row.names = FALSE, quote = FALSE)


write.table(annotations_merged_df_mix, file = args[5], sep = '\t', row.names = FALSE, quote = FALSE)
